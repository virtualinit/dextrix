...
<table width="150%" border="0">
  ...
  <tr>
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='usercolleges.php?cps=$lps'>Previous</a>"; 
    } 
    else    
    { 
        $prv =  "<font color='CCCCCC'>Previous</font>"; 
    } 
    $q="Select SQL_CALC_FOUND_ROWS university, college, location, website, expect, name, date from colleges WHERE status = 'Approved' ORDER BY date Desc limit $cps, $rpp"; 
...
<table width="946" height="100" border="1" align="center" cellpadding="2" cellspacing="2">
    ...
    { 
        if ($nr0 > 1) 
        { 
            echo "  |  <a href='usercolleges.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ?>
	</td>
