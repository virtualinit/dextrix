...
<table width="150%" border="0">
  ...
  <tr>
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='usertasks.php?cps=$lps'>Previous</a>"; 
    } 
    else    
    { 
        $prv =  "<font color='CCCCCC'>Previous</font>"; 
    } 
    $q="Select SQL_CALC_FOUND_ROWS task, dept, reportdate, status from deadlines WHERE status = 'Accomplished' ORDER BY reportdate Desc limit $cps, $rpp"; 
    ...
    ?> 
<br> 
<table width="622" height="100" border="1" align="center" cellpadding="2" cellspacing="2">
	<tr>
	<th><font face="Arial, Helvetica, sans-serif">Task</font></th>
	<th><font face="Arial, Helvetica, sans-serif">Dextrix Domain</font></th>
    ...
    { 
        if ($nr0 > 1) 
        { 
            echo "  |  <a href='usertasks.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ?>
	</td>
