...
<table width="96%" border="0" align="center">
  <tr>
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='mm.php?cps=$lps'>Previous</a>"; 
    } 
    else    
    { 
        $prv =  "<font color='CCCCCC'>Previous</font>"; 
    } 
    $q="Select SQL_CALC_FOUND_ROWS * from companies WHERE mmanager = '$activeuser' LIMIT $cps, $rpp"; 
...
<table width="896" height="100" border="1" align="center" cellpadding="2" cellspacing="2">
	...
	<th><font face="Arial, Helvetica, sans-serif">Contact Status</font></th>
	<th><font face="Arial, Helvetica, sans-serif">Response</font></th>
	<th><font face="Arial, Helvetica, sans-serif">Approach</font></th>
    ...
    { 
        if ($nr0 > 1) 
        { 
            echo "  |  <a href='mm.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ?>
</table>
