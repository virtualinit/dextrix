...
<table width="151%" border="0" align="center">
  <tr>
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='listrequests.php?cps=$lps'>Previous</a>"; 
    } 
    else    
    { 
        $prv =  "<font color='CCCCCC'>Previous</font>"; 
    } 
    $q="Select SQL_CALC_FOUND_ROWS * from marketing limit $cps, $rpp"; 
...
<table width="946" height="100" border="1" align="center" cellpadding="2" cellspacing="2">
	...
	<th><font face="Arial, Helvetica, sans-serif">Candidate</font></th>
    ...
    { 
        if ($nr0 > 1) 
        { 
            echo "  |  <a href='listrequests.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ?>
	</td>
