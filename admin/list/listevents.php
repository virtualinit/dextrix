...
<table width="151%" border="0" align="center">
  <tr>
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='listevents.php?cps=$lps'>Previous</a>"; 
    } 
    else    
    { 
...
<table width="946" height="100" border="1" align="center" cellpadding="2" cellspacing="2">
	...
	<th><font face="Arial, Helvetica, sans-serif">Event</font></th>
    ...
    { 
		...
		$f6=$row["budget"];
		$f7=$row["mockdate"];
		$f8=$row["eventpromotion"];
		$f9=$row["eventsponsors"];
		$f10=$row["lastupdate"];
	?>
    ...
    { 
        if ($nr0 > 1) 
        { 
            echo "  |  <a href='listevents.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ?>
	</td>
