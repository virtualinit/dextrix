...
<div class="story">
  <form id="form1" method="post" action="addmilestone1.php">
    <table width="66%" border="0" align="center">
      ...
      <tr>
        <td>Task: </td>
        <td><input name="txttask" type="text" id="txttask" /></td>
      </tr>
      <tr>
        <td>Department:</td>
        <td><select name="mnudept" id="mnudept">
          ...
          <option value="Colleges Relationship" selected="selected">Colleges Relationship</option>
          <option value="Dextrix Night">Dextrix Night</option>
          <option value="Event: Outdoors">Event: Outdoors</option>
          <option value="Event: Competitions">Event: Competitions</option>
          <option value="Online Events">Online Events</option>
          <option value="Innovations">Innovations</option>
          <option value="Event: Unwind">Event: Unwind</option>
          <option value="Visual Show">Visual Show</option>
          <option value="Gaming">Gaming</option>
        </select>        </td>
      </tr>
      <tr>
        <td>Report Date:</td>
        <td><input name="txtreport" type="text" id="txtreport" />
          [YYYY-MM-DD]</td>
      </tr>
      ...
      <tr>
        ...
        <td><input type="submit" name="Submit" value="Add Milestone" /></td>
      </tr>
    </table>
  </form>
</div>
