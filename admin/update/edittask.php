...
<div id="content">
  ...
  <div id="posts">
    ...
    <div class="post">
      <form id="form1" method="post" action="edittask1.php">
        <table width="80%" border="0" align="center">
          ...
          <tr>
            <td width="36%"><div align="right">Milestone:</div></td>
            <td width="64%"><input name="txtno" type="text" id="txtno" /></td>
          </tr>
          <tr>
            <td><div align="right">Report Date: </div></td>
          ...
          <tr>
            ...
            <td><input type="submit" name="Submit" value="Fix Task" /></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
