...
function chk($no)
		{
			$query1 = "SELECT eventno FROM events WHERE eventno = '$no'";
...
$query = "UPDATE events SET mentor = '$mentor', eventsponsors = '$sponsor' WHERE eventno = '$no'";
...
<div id="content">
  ...
  <div id="posts">
    ...
    <div class="post">
	  ...
	  if ($counter = -1)
	  {
	  	echo "Records for <b>Event No: $no</b>  updated successfully.";
		}
	  ?></td>
        </tr>
      </table>
