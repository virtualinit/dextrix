    ...
    <div class="post">
      <table width="96%" border="0" align="center">
		...
		{ 
			if (chk($ref))
			{
		$query = "UPDATE companies SET location = '$location', companyemail = '$email', mmanager = '$mm', contactstatus = '$contact', response = '$response', sponsorship = '$sponsor', brand = '$brand', date = CURDATE(), status = '$status' WHERE refno = '$ref'";
		...
		else echo "<br><b>Company Reference Number has not been entered!!";
	  ?>
	  </td>
          </tr>
      </table>
