  ...
  <div id="posts">
    ...
    <div class="post">
      <table width="91%" border="0" align="center">
		...
		function chk($no)
		{
			$query1 = "SELECT refno FROM colleges WHERE refno = '$no'";
		...
		$query = "UPDATE colleges SET status = '$status', date = CURDATE() WHERE refno = '$no'";

		$result = mysql_query($query);
		if(!$result){echo "<br>".mysql_error();} else echo "College updated successfully !!";
		
			}
			else echo "<br><b>Invalid Reference Number entered!!";
		}
		else echo "<br><b>College Reference Number has not been entered!!";
	  ?>
	  </td>
        </tr>
      </table>
