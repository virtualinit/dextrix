      ...
      <table width="92%" border="0" align="center">
		...
		{ 
			if (chk($ref))
			{
				if (chk1($ref))
				{
		$query = "UPDATE companies SET location = '$location', companyemail = '$email', contactstatus = '$contact', response = '$response', sponsorship = '$sponsor', brand = '$brand', date = CURDATE(), status = '$status' WHERE refno = '$ref' AND mmanager = '$activeuser'";
