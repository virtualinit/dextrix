...
<table width="150%" border="0">
  <tr>
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='listcolleges5.php?cps=$lps'>Previous</a>"; 
    } 
    else    
    { 
        $prv =  "<font color='CCCCCC'>Previous</font>"; 
    } 
    $q="Select SQL_CALC_FOUND_ROWS * from colleges WHERE status = 'Approved' ORDER BY date Desc limit $cps, $rpp"; 
    ...
    ?> 
<br> 
<table width="924" height="100" border="1" align="center" cellpadding="2" cellspacing="2">
	<tr>
	<th><font face="Arial, Helvetica, sans-serif">No</font></th>
	<th><font face="Arial, Helvetica, sans-serif">University</font></th>
	<th><font face="Arial, Helvetica, sans-serif">College Name</font></th>
	<th><font face="Arial, Helvetica, sans-serif">Location</font></th>
	<th><font face="Arial, Helvetica, sans-serif">Website</font></th>
	<th><font face="Arial, Helvetica, sans-serif">Strength Expected</font></th>
    ...
    { 
        if ($nr0 > 1) 
        { 
            echo "  |  <a href='listcolleges5.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ?>
	</td>
