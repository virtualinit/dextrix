...
<table width="150%" border="0">
  <tr>
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='listevents5.php?cps=$lps'>Previous</a>"; 
    } 
    else    
    { 
        $prv =  "<font color='CCCCCC'>Previous</font>"; 
    } 
    $q="Select SQL_CALC_FOUND_ROWS * from events limit $cps, $rpp"; 
...
<table width="896" height="100" border="1" align="center" cellpadding="2" cellspacing="2">
	...
	<th><font face="Arial, Helvetica, sans-serif">Promotion</font></th>
	<th><font face="Arial, Helvetica, sans-serif">Sponsors</font></th>
    ...
    { 
		...
		$f5=$row["budget"];
		$f6=$row["mockdate"];
		$f7=$row["eventpromotion"];
		$f8=$row["eventsponsors"];
		$f9=$row["lastupdate"];
	?>
    ...
    { 
        if ($nr0 > 1) 
        { 
            echo "  |  <a href='listevents5.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ?>
	</td>
