...
<table width="150%" border="0">
  <tr>
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='listtasks5.php?cps=$lps'>Previous</a>"; 
    } 
    else    
    { 
        $prv =  "<font color='CCCCCC'>Previous</font>"; 
    } 
    $q="Select SQL_CALC_FOUND_ROWS * from deadlines limit $cps, $rpp"; 
...
<table width="896" height="100" border="1" align="center" cellpadding="2" cellspacing="2">
	...
	<th><font face="Arial, Helvetica, sans-serif">Report Date</font></th>
    ...
    { 
        if ($nr0 > 1) 
        { 
            echo "  |  <a href='listtasks5.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ?>
	</td>
