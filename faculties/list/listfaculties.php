...
<table width="150%" border="0">
  <tr>
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='listfaculties.php?cps=$lps'>Previous</a>"; 
    } 
    else    
    { 
        $prv =  "<font color='CCCCCC'>Previous</font>"; 
    } 
    $q="Select SQL_CALC_FOUND_ROWS * from users WHERE role = '$activerole' limit $cps, $rpp"; 
    ...
    ?> 
<br> 
<table width="896" height="100" border="1" align="center" cellpadding="2" cellspacing="2">
	<tr>
	<th><font face="Arial, Helvetica, sans-serif">Acc No</font></th>
	<th><font face="Arial, Helvetica, sans-serif">Login Name</font></th>
	...
	<th><font face="Arial, Helvetica, sans-serif">Created On</font></th>
	<th><font face="Arial, Helvetica, sans-serif">Created By</font></th>
</tr>
    <? 
    ...
    { 
        if ($nr0 > 1) 
        { 
            echo "  |  <a href='listfaculties.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ?>
	</td>
