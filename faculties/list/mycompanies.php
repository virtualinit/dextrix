...
<div id="posts">
<div class="post">
<h2 class="title">my companies...</h2>
</div>
<div class="post">
  <div class="story">
<table width="150%" border="0">
  <tr>
    ...
    if ($cps <> 0) 
    { 
        $prv =  "<a href='mycompanies.php?cps=$lps'>Previous</a>"; 
    } 
    else    
    { 
    ...
    ?> 
<br> 
<table width="921" height="100" border="1" align="center" cellpadding="2" cellspacing="2">
	<tr>
    ...
    { 
        if ($nr0 > 1) 
        { 
            echo "  |  <a href='mycompanies.php?cps=$cps&lps=$lps'>Next</a>"; 
        } 
    } 
    ?>
	</td>
